...
public class BitConverter {
	  public static byte[] getBytes(short data)
	    ...
	    {
	    	short temp=(short) ((0xff & bytes[startIndex]) | (0xff00 & (bytes[startIndex + 1] << 8)));
	    	return temp&0xffff;
	       
	    }
	    public static int getUnsignedByte(byte[] bytes,int startIndex)
	    {
	    ...
	    public static String getUTF8String(byte[] bytes, int startindex,int length)
	    {
