...
public class EquipmentsActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		adapter = new SimpleAdapter(this, DataAccess.equipmentslisttitems, R.layout.equipmentslayoutitem, ColumnNames,
				new int[] { R.id.equipment_list_id, R.id.equipment_list_Name, R.id.data0, R.id.data1, R.id.data2,
						R.id.data3, R.id.image });
			...
			case 0:
				...
				LoginActivity.xianChengChi.execute(new Runnable() {
					...
					public void run() {
						...
						DataAccess.GetEquipmentsWithOverViewData(DataAccess.stationid, DataAccess.roomid,handler);
