...
public class EquipmentViewPagerActivity extends Activity implements Runnable {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			adapteranalog = new SimpleAdapter(this, DataAccess.equipmentanalogsignalsitems,
					R.layout.equipmentanalogsignalitem, ColumnNames, new int[] { R.id.signals_list_id,
							R.id.signals_list_Name, R.id.signals_list_value, R.id.signals_list_unit });
			...
			adapterswitch = new SimpleAdapter(this, DataAccess.equipmentswitchsignalsitems,
					R.layout.equipmentswitchsignalitem, ColumnNames1,
			...
			adapteralarm = new SimpleAdapter(this, DataAccess.equipmentalarmitems, R.layout.equipmentalarmsignalitem,
					ColumnNames2, new int[] { R.id.equipment_active_alarm_id, R.id.equipment_active_alarm_descript,
							R.id.equipment_active_alarm_starttime, R.id.equipment_active_alarm_level });
			...
			adapterconmmnd = new SimpleAdapter(this, DataAccess.equipmentcommanditems, R.layout.equipmentcommad,
					ColumnNames3, new int[] { R.id.commnd_list_id, R.id.commnd_list_Name, R.id.commnd_list_value });
					...
					public void onClick(DialogInterface arg0, int arg1) {
						...
						new Thread(new Runnable() {
							...
							public void run() {
								...
								DataAccess.getEquipmentCommandControl(DataAccess.stationid, DataAccess.roomid,
										DataAccess.equipmentid, arg2);
			...
			case 0:
				...
				LoginActivity.xianChengChi.execute(new Runnable() {
					...
					public void run() {
						...
						DataAccess.GetEquipmentAnalogSignalsCfg(DataAccess.stationid, DataAccess.roomid, DataAccess.equipmentid);
						DataAccess.GetRealTimeAnalogSignals(DataAccess.stationid, DataAccess.roomid,
								DataAccess.equipmentid,handler);
			...
			case 1:
				...
				LoginActivity.xianChengChi.execute(new Runnable() {
					...
					public void run() {
						...
						DataAccess.GetEquipmentSwitchSignalsCfg(DataAccess.stationid, DataAccess.roomid,
								DataAccess.equipmentid);
						bGetSwitch = true;

						DataAccess.GetRealTimeSwitchSignals(DataAccess.stationid, DataAccess.roomid,
								DataAccess.equipmentid,handler);
			...
			case 2:
				...
				LoginActivity.xianChengChi.execute(new Runnable() {
					...
					public void run() {
						...
						DataAccess.GetEquipmentActiveAlarm(DataAccess.stationid, DataAccess.roomid,
								DataAccess.equipmentid,handler);
						Log.e("tag", "2");
					}
				});
			...
			case 3:
				...
				LoginActivity.xianChengChi.execute(new Runnable() {
					...
					public void run() {
						...
						DataAccess.GetEquipmentCommand(DataAccess.stationid, DataAccess.roomid, DataAccess.equipmentid,handler);
						Log.e("tag", "3");
					}
				});
	...
	private void InitImageView() {
		...
		bmpW = BitmapFactory.decodeResource(getResources(), R.drawable.blue).getWidth();
		// 获取图片宽度
